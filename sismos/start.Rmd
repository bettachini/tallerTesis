...
```{r coeficientes de la regresión logística}
...
sismos_SJ[, prob := predict(logit_model, newdata = sismos_SJ, type = "response")]
...
# Create a ROC curve
roc_curve <- roc(sismos_SJ$Percibido, sismos_SJ$prob)
