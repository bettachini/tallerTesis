...
Saltan a la vista que hay valores extremos en el extremo suporior de la variable \verb'Magnitud' bastante alejados de la mediana y que hay un fuerte desequilibrio en la variable ``Percibido'', la de clase de clasificación, en favor de los terremotos no percibidos.


\paragraph{Desequilibrio en la clase de clasificación}
Sobre el total de 55794 registros únicos solo un valor cercano al \(96.6\%\) fueron percibidos por el instrumental y no por la población.
Restan tan solo unos 1905 registros, \(3.4\%\) del total, que efectivamente fueron percibidos por la población.
...
\caption{Los sismos de mayor magnitud son más infrecuentes. Reproducido con el código provisto en \cite{daniela_parada_sismos-arg_nodate}.}
\label{fig:acumulado_anual_magnitud}
\end{figure}
